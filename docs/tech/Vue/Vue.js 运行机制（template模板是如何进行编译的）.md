---
title: "Vue.js js 运行机制（template模板是如何进行编译的）"
sidebarDepth: 2
---
...
Vue 内部的 compile 编译可以分成 parse、optimize 与 generate 三个阶段，最终需要得到 render function。

这里我们提供一个 template 的示例，通过这个示例来学习 Vue 的解析过程。
...
parse 会用正则等方式将 template 模板中进行字符串解析，得到指令、class、style 等数据，形成 AST（[在计算机科学中，抽象语法树（abstract syntax tree 或者缩写为 AST），或者语法树（syntax tree），是源代码的抽象语法结构的树状表现形式，这里特指编程语言的源代码。](https://zh.wikipedia.org/wiki/%E6%8A%BD%E8%B1%A1%E8%AA%9E%E6%B3%95%E6%A8%B9)）。
...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/1/7/160d00562f38ab39~tplv-t2oaga2asx-zoom-in-crop-mark:3024:0:0:0.awebp)
调用 advance 函数
...
得到结果
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/1/7/160d0058331006a5~tplv-t2oaga2asx-zoom-in-crop-mark:3024:0:0:0.awebp)
...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/1/7/160d0f34a5642ce8~tplv-t2oaga2asx-zoom-in-crop-mark:3024:0:0:0.awebp)
